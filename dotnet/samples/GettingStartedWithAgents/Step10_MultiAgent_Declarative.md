...
This C# code demonstrates how to declaratively create and use Semantic Kernel Agents for multi-agent orchestration using Microsoft Semantic Kernel. The class `Step10_MultiAgent_Declarative` inherits from a test base and contains examples of creating both a Chat Completion Agent and an Azure AI Agent by parsing YAML definitions. It illustrates interacting with these agents through chat interfaces and shows how agent resources can be cleaned up after use. The constructor sets up the appropriate Kernel, OpenAI, and Azure AI clients, and configures factories to instantiate agents as required.
