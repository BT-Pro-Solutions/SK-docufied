...
This C# file demonstrates how to add and configure AI services—specifically Azure OpenAI and OpenAI chat completion models—within a Semantic Kernel. It contains an example class `AIServices` that checks for necessary credentials, conditionally sets up the kernel with the respective AI services using those credentials, and provides sample code snippets for both Azure and OpenAI model integration. This example is relevant for developers working with Microsoft Semantic Kernel to interact with large language models via Azure or OpenAI.
